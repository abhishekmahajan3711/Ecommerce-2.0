...
export const validateIndianAddress = (address) => {
  ...
  // Check if city is in the major cities list (optional validation)
  if (address.city && !indianAddressData.majorCities.includes(address.city)) {
    // This is just a warning, not an error
    console.log('City not in major cities list, but this is acceptable');
  }
